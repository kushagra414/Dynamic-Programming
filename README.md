...
- [ ] [Write your own strcmp that ignores cases](https://www.geeksforgeeks.org/write-your-own-strcmp-which-ignores-cases/)
...
- [ ] [XOR counts of 0s and 1s in binary representation](https://www.geeksforgeeks.org/xor-counts-0s-1s-binary-representation/)
- [ ] [Calculate XOR from 1 to n.](https://www.geeksforgeeks.org/calculate-xor-1-n/)
...
- [ ] [Check if a number has bits in alternate pattern | Set 1](https://www.geeksforgeeks.org/check-if-a-number-has-bits-in-alternate-pattern/)
- [ ] [XOR of two numbers after making length of their binary representations equal](https://www.geeksforgeeks.org/xor-two-numbers-making-length-binary-representations-equal/)
- [ ] [Count minimum bits to flip such that XOR of A and B equal to C](https://www.geeksforgeeks.org/count-minimum-bits-flip-xor-b-equal-c/)
- [ ] [Efficient method for 2’s complement of a binary string](https://www.geeksforgeeks.org/efficient-method-2s-complement-binary-string/)
- [ ] [Toggle case of a string using Bitwise Operators](https://www.geeksforgeeks.org/toggle-case-string-using-bitwise-operators/)
- [ ] [Toggling k-th bit of a number](https://www.geeksforgeeks.org/toggling-k-th-bit-number/)
- [ ] [Convert decimal fraction to binary number](https://www.geeksforgeeks.org/convert-decimal-fraction-binary-number/)
- [ ] [Toggle all the bits of a number except k-th bit.](https://www.geeksforgeeks.org/toggle-bits-number-except-k-th-bit/)
- [ ] [Set the rightmost unset bit](https://www.geeksforgeeks.org/set-rightmost-unset-bit/)
- [ ] [Convert a binary number to octal](https://www.geeksforgeeks.org/convert-binary-number-octal/)
- [ ] [Check in binary array the number represented by a subarray is odd or even](https://www.geeksforgeeks.org/check-binary-array-number-represented-subarray-odd-even/)
- [ ] [Toggle the last m bits](https://www.geeksforgeeks.org/toggle-last-m-bits/)
...
- [ ] [Find the largest number with n set and m unset bits](https://www.geeksforgeeks.org/find-largest-number-n-set-m-unset-bits/)
- [ ] [Find the smallest number with n set and m unset bits](https://www.geeksforgeeks.org/find-smallest-number-n-set-m-unset-bits/)
- [ ] [Sum of numbers with exactly 2 bits set](https://www.geeksforgeeks.org/sum-numbers-exactly-2-bits-set/)
- [ ] [Check if binary representation of a given number and its complement are anagram](https://www.geeksforgeeks.org/sum-numbers-exactly-2-bits-set/)
- [ ] [Check a number is odd or even without modulus operator](https://www.geeksforgeeks.org/3-ways-check-number-odd-even-without-using-modulus-operator-set-2-can-merge-httpswww-geeksforgeeks-orgcheck-whether-given-number-even-odd/)
- [ ] [Bitwise recursive addition of two integers](https://www.geeksforgeeks.org/bitwise-recursive-addition-two-integers/)
- [ ] [Print bitwise AND set of a number N](https://www.geeksforgeeks.org/print-bitwise-and-set-of-a-number-n/)
- [ ] [Fast average of two numbers without division](https://www.geeksforgeeks.org/fast-average-two-numbers-without-division/)
- [ ] [Maximum XOR-value of at-most k-elements from 1 to n](https://www.geeksforgeeks.org/maximum-xor-value-k-elements-1-n/)
- [ ] [Swap every two bits in bytes](https://www.geeksforgeeks.org/swap-every-two-bits-bytes/)
- [ ] [Check if a number is divisible by 8 using bitwise operators](https://www.geeksforgeeks.org/check-number-divisible-8-using-bitwise-operators/)
...
- [ ] [Toggle bits of a number except first and last bits](https://www.geeksforgeeks.org/toggle-bits-number-expect-first-last-bits/)
- [ ] [Check if given four integers (or sides) make rectangle](https://www.geeksforgeeks.org/check-given-four-integers-sides-make-rectangle/)
- [ ] [Toggle all even bits of a number](https://www.geeksforgeeks.org/toggle-first-last-bits-number/)
- [ ] [Set the Left most unset bit](https://www.geeksforgeeks.org/set-left-unset-bit/)
- [ ] [Maximum XOR using K numbers from 1 to n](https://www.geeksforgeeks.org/maximum-xor-using-k-numbers-1-n/)
- [ ] [Python | Count set bits in a range](https://www.geeksforgeeks.org/python-count-set-bits-range/)
- [ ] [Python map function | Count total set bits in all numbers from 1 to n](https://www.geeksforgeeks.org/python-map-function-count-total-set-bits-numbers-1-n/)
...
- [ ] [Euclid’s Algorithm when % and / operations are costly](https://www.geeksforgeeks.org/euclids-algorithm-when-and-operations-are-costly/)
...
- [ ] [Find even occurring elements in an array of limited range](https://www.geeksforgeeks.org/find-even-occurring-elements-array-limited-range/)
...
- [ ] [Find profession in a special family](https://www.geeksforgeeks.org/find-profession-in-a-hypothetical-special-situation/)
...
- [ ] [Check if bits of a number has count of consecutive set bits in increasing order](https://www.geeksforgeeks.org/check-bits-number-count-consecutive-set-bits-increasing-order/)
- [ ] [Subset sum queries using bitset](https://www.geeksforgeeks.org/subset-sum-queries-using-bitset/)
- [ ] [Maximum 0’s between two immediate 1’s in binary representation](https://www.geeksforgeeks.org/maximum-0s-two-immediate-1s-binary-representation/)
...
- [ ] [Efficiently check if a string has all unique characters without using any additional data structure](https://www.geeksforgeeks.org/efficiently-check-string-duplicates-without-using-additional-data-structure/)
- [ ] [Count trailing zero bits using lookup table](https://www.geeksforgeeks.org/count-trailing-zero-bits-using-lookup-table/)
- [ ] [Count smaller numbers whose XOR with n produces greater value](https://www.geeksforgeeks.org/count-smaller-numbers-whose-xor-n-produces-greater-value/)
...
- [ ] [Sum of Bitwise And of all pairs in a given array](https://www.geeksforgeeks.org/calculate-sum-of-bitwise-and-of-all-pairs/)
