...
- [ ] [Largest number with given sum](https://practice.geeksforgeeks.org/problems/largest-number-with-given-sum/0)
- [ ] [Huffman Decoding-1](https://practice.geeksforgeeks.org/problems/huffman-decoding-1/1)
- [ ] [Fact Digit Sum](https://practice.geeksforgeeks.org/problems/fact-digit-sum/0)
- [ ] [Check if it is possible to survive on Island](https://practice.geeksforgeeks.org/problems/check-if-it-is-possible-to-survive-on-island/0)<br>
**Aptitude:**
