...
- [ ] [Minimum Time](https://practice.geeksforgeeks.org/problems/minimum-time/0)
- [ ] [Longest Common Substring](https://practice.geeksforgeeks.org/problems/longest-common-substring/0)
- [ ] [Sum of all substrings of a number](https://practice.geeksforgeeks.org/problems/sum-of-all-substrings-of-a-number/0)
- [ ] [Max Sum without Adjacents](https://practice.geeksforgeeks.org/problems/max-sum-without-adjacents/0)
- [ ] [Reach a given score](https://practice.geeksforgeeks.org/problems/reach-a-given-score/0)
...
- [ ] [Count the number of ways to tile the floor of size n x m using 1 x m size tiles](https://practice.geeksforgeeks.org/problems/count-the-number-of-ways-to-tile-the-floor-of-size-n-x-m-using-1-x-m-size-tiles/0)
