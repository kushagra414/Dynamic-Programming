...
- [ ] [Solve Aptitude Questions, Complete Problems on Average - Data Sufficiency 2](https://www.indiabix.com/aptitude/average/008001)<br>
**Algorithms : Read**
...
### **Day 15**
#### Tasks
- [x] [Painting Fence Algorithm](https://www.geeksforgeeks.org/painting-fence-algorithm/)
...
- [x] [Longest Common Subsequence](https://practice.geeksforgeeks.org/problems/longest-common-subsequence/0)<br>
...
- [x] [Pairs with specific difference](https://practice.geeksforgeeks.org/problems/pairs-with-specific-difference/0)<br>
